...
function OrderVideoPage() {
    ...
    if (!client || !call) {
        return (
            <div className="flex min-h-[480px] items-center justify-center rounded-box border border-base-300 bg-base-100">
                ...
                <div className="card-body flex-row items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-base-content/70">
                            Same room as the invite link in chat. Allow camera and microphone when your browser asks.
                        </p>
                    </div>
                </div>
            </div>

            <div className="flex min-h-140 flex-col overflow-hidden rounded-box border border-base-300 bg-base-100">
                <StreamVideo client={client}>
                    <StreamCall call={call}>
                        <StreamTheme className="str-video___theme-custom">
                            <div className="flex min-h-0 flex-1 flex-col">
                                <div className="relative min-h-[420px] flex-1 bg-neutral text-neutral-content">
                                    <SpeakerLayout />
                                </div>
                                <div className="shrink-0 border-t border-base-300 bg-base-200/90 px-2 py-3 flex justify-center">
