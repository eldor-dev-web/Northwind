...
function sendShippingTimeoutError() {
    ...
    Sentry.withScope((scope) => {
        applyDemoScope(scope, "carrier-timeout");
...
export function SentryDemoPage() {
    ...
    return (
        <div className="mx-auto max-w-3xl">
            ...
            ), <strong className="rounded bg-base-content/85">Issues</strong> (
                <code className="rounded bg-base-300 px-1 py-0.5 text-xs">Exception</code>
            ...
            <ul className="mt-8 divide-y divide-base-300 rounded-box border border-base-300 bg-base-100">
                ...
                <li className="flex flex-col gap-3 px-4 py-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <p className="font-medium text-base-content">API limit (warning)</p>
                        <p className="mt-1 text-sm text-base-content/65">
            ...
            {lastAction ? (
                <p className="mt-6 text-sm text-success" role="status">
                    Last send: <span className="font-mono">{lastAction}</span> - open Sentry to see new issues
                    or the stream.
                </p>
            ) : null}
            
            <p className="mt-8 text-sm text-base-content/55">
                <Link to="/" className="link link-hover inline-flex items-center gap-2">
