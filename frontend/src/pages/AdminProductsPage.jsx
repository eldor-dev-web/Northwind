...
import { AdminProductsTablesSkeleton } from "../components/LoadingSkeletons.jsx";
import { IK_PRESETS, imageKitOptimizedUrl } from "../lib/imagekitUrl.js";
import { PackageIcon, PencilIcon, PlusIcon, Trash2Icon } from "lucide-react";
import { formatPrice } from "../utlis/format.js";
...
function AdminProductsPage() {
    ...
    return (
        <div className="text-left">
            ...
            {isLoading ? (
                <AdminProductsTablesSkeleton />
            ) : (
                <div className="overflow-x-auto rounded-box border-base-300 bg-base-100">
                        ...
                        <tbody>
                            {products.map((p) => (
                                <tr key={p.id}>
                                    ...
                                    <td>
                                        <span className="badge badge-ghost badge-sm">{p.category ?? "_"}</span>
                                    </td>
