...
import { formatOrderWhen, formatPrice } from "../utlis/format";
...
export default function OrderDetailPage() {
    ...
    return (
        <div className="space-y-8 text-left mx-auto max-w-4xl p-6">
            <Link
                to="/orders"
                className="btn btn-ghost btn-sm gap-2 px-0 text-base-content/70 hover:text-primary inline-flex items-center"
            >
            ...
            <div className="overflow-hidden rounded-2xl border border-base-300 bg-base-100 shadow-lg">
                <div className="bg-gradient-to-br from-primary/12 via-base-100 to-base-200/90 px-5 pt-6 sm:px-8 sm:py-8">
