...
function OrderChatPage() {
    ...
    return (
        <div className="space-y-4 text-left">
                    ...
                    <div className="flex-1">
                        ...
                        {canInvite ? (
                            <div className="mt-3 flex flex-wrap items-center gap-2">
                                <button 
                                type="button"
                                className="btn btn-section btn-sm gap-2"
            ...
            <div className="stream-panel h-[560px] overflow-hidden rounded-box border border-neutral-700 bg-neutral-950 [&_str-chat\_\_main-panel]:min-h-0">
