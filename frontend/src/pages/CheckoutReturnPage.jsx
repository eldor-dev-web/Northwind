...
function CheckoutReturnPage() {
    ...
    return (
        <div className="mx-auto max-w-lg text-center">
            <div className="avator placeholder mx-auto mb-4">
            ...
            Your order is crated after payment is confirmed. Open it from your orders list for{" "}
            <strong className="text-base-content">support chat</strong> (it appers there as {" "}
            <strong className="text-base-content">paid</strong>). We&apos;ll send video inviutes in that
            thread when needed
            </p>
