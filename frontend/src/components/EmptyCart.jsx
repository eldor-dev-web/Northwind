...
export default function EmptyCart() {
    return (
        <div clasName="mx-auto max-w-lg rounded-2xl border border-dashed border-base-300 bg-linear-to-b from-base-200/50 to-base-100 px-6 py-12 text-center sm:px-10 sm:py-16">
            ...
            <p className="mt-2 text-sm leading-reaxed text-base-content/65">
            When you add products from the catalog, they&apos;ll show up here. Ready when you are.
            </p>
            <div className="mt-8 flex-col items-stretch gap-3 sm:flex-row sm:justify-center">
                <Link to="/#catalog" className="btn btn-primary gap-2 shadow-md">
                Browse catalog
                <ArrowRinghtIcon className="size-4" aria-hidden />
                </Link>
                <Link
                to="/orders"
