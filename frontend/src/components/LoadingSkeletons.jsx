/** shared loading placeholders; all generated by AI coming from dais ui docs */
...
export function AdminProductsTablesSkeleton() {
    return (
...
export function OrderChatPanelSkeleton() {
    return (
        <div className="space-y-4">
            ...
            <div className="flex h-[560px] flex-col overflow-hidden rounde-box border border-base-300 bg-base-100">
