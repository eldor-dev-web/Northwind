...
import { useCart } from "../store/cart.js";
 ...
 export default function CatalogProductCard({ product }) {
    ...
    return (
        <article className="card group h-full overflow-hidden biorder border-base-300 bg-base-100 shadow-md transition hover:-translate-y-0.5 hover:border-primary/40 hover:shadow-xl">
